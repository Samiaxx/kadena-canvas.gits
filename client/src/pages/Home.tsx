...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col p-4 md:p-8 max-w-[1600px] mx-auto">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="flex-1 relative min-h-[600px] glass-panel rounded-xl p-1 overflow-hidden">
